...
export class ProductAdminComponent {
  ...
  saveProduct() {
    if (this.repo.product.productId == null) {
      ...
      // changes.set("category", this.repo.product.category);
      // changes.set("description", this.repo.product.description);
      // changes.set("price", this.repo.product.price);
      // changes.set("supplier", this.repo.product.supplier);
